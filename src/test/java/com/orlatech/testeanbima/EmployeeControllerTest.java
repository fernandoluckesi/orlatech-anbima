...
public class EmployeeControllerTest {
        ...
        void shouldReturnAllEmployees() throws Exception {
                ...
                List<ProjectInEmployeeResponseDTO> projectInEmployeeResponseDTOs = Arrays
                                .asList(new ProjectInEmployeeResponseDTO(
                                                UUID.fromString("1ecbb921-8a5f-4b2d-a629-40243772bd06"),
                ...
                List<EmployeeResponseDTO> employees = Arrays.asList(
                                new EmployeeResponseDTO(UUID.fromString("ffb20824-48c2-4c17-a11f-f2a6cf9647cd"),
                                                "Fernando Luckesi 0",
                                                ...
                                                projectInEmployeeResponseDTOs),
                                new EmployeeResponseDTO(UUID.fromString("e96aaaf7-46e6-4de6-93b6-b74f04b71ce0"),
                                                "Fernando Luckesi 1",
                ...
                mockMvc.perform(MockMvcRequestBuilders.get("/employees"))
                                ...
                                .andExpect(jsonPath("$[0].projects[0].id")
                                                .value("1ecbb921-8a5f-4b2d-a629-40243772bd06"))
        ...
        void shouldReturnUniqueEmployee() throws Exception {
                ...
                when(employeeService.getById(UUID.fromString("ffb20824-48c2-4c17-a11f-f2a6cf9647cd")))
                                .thenReturn(employee);
